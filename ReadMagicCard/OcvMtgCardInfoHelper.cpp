...
double OcvMtgCardInfoHelper::CompareCardNames(const wstring name1, const wstring name2) {
...
void OcvMtgCardInfoHelper::RemoveCharactersNotRelevantForNameSorting(const wstring cardName, wstring& result) {
